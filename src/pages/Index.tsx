...
const Index = () => {
  ...
  const activities = [
    {
      icon: Mountain,
      titleKey: "explore.hiking",
      descKey: "explore.hikingDesc",
      gradient: "from-[hsl(152,35%,25%)] to-[hsl(152,25%,40%)]",
    },
    {
      icon: TreePine,
      titleKey: "explore.forest",
      descKey: "explore.forestDesc",
      gradient: "from-[hsl(30,40%,35%)] to-[hsl(30,30%,50%)]",
    },
    {
      icon: Landmark,
      titleKey: "explore.churches",
      descKey: "explore.churchesDesc",
      gradient: "from-[hsl(38,60%,40%)] to-[hsl(38,50%,55%)]",
    },
    {
      icon: Users,
      titleKey: "explore.traditions",
      descKey: "explore.traditionsDesc",
    ...
    <div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-background font-semibold mb-4 tracking-wide">
            {t("hero.title")}
          </h1>
          <p className="font-body text-base sm:text-lg md:text-xl text-background/90 mb-8 max-w-2xl mx-auto">
            {t("hero.subtitle")}
          </p>
